...
csiphy_reg_t csiphy_3ph_v1_2_3_reg_custom[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		...
		{0x016C, 0x0F, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x015C, 0xC9, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	},
	{
		...
		{0x036C, 0x0F, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x035C, 0xC9, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	},
	{
		...
		{0x056C, 0x0F, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x055C, 0xC9, 0x00, CSIPHY_DEFAULT_PARAMS},
